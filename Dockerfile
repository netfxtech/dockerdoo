...
# ADD https://netfxtech.com/document/share/7/5ce31bb0-d9eb-48c2-8114-e143fef5a1a8 /opt/odoo
...
RUN pip3 install --no-cache-dir pdfminer.six pyopenssl==22.0.0 \
    && rm -rf /var/lib/apt/lists/* /tmp/*
